      ...
      <div className='w-full h-full bg-white rounded-lg shadow-lg flex flex-col'>
        <header className='border-b border-gray-200 p-6'>
          ...
          <p className='text-gray-600 text-center mt-2'>
            Unggah folder lengkap berisi gambar untuk dikategorikan secara
            otomatis
          </p>
        </header>
        ...
        <main className='flex-1 flex flex-col items-center justify-start p-6 overflow-y-auto'>
          <div className='w-full max-w-4xl'>
            <FolderUpload onChange={handleFileChange} />
            {files.length > 0 && (
              <div className='mt-4 text-center'>
                <p className='text-gray-700'>
                  {files.length} file dalam folder dipilih
                </p>
                ...
                {!response && (
                  <div className='mt-6 w-full'>
                    <Button
                      ...
                      size={'lg'}
                      className='w-full !bg-purple-500 !hover:bg-purple-600 text-white flex items-center justify-center gap-x-2 py-3'
                    >
                      <IconFolderOpen className='size-5' />
                      {isLoading ? 'Memproses Folder...' : 'Unggah Folder'}
                    </Button>
                  </div>
                )}
              </div>
          ...
          {isLoading && (
            <div className='mt-6 text-center'>
              <p className='text-gray-600'>
                Sedang memproses folder, mohon tunggu...
              </p>
            </div>
          )}
